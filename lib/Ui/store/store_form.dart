...
class StoreForm extends StatefulWidget {
  static const String routeName = "/store_form";
...
class _StoreFormState extends State<StoreForm> {
  ...
  submit() async {
    ...
    var response = await MjApiService()
        .postRequest(MJ_Apis.create_store + "/" + user!.id!, data);
    hideProgressDialog(context);
    if (response != null) {
