...
class SingleItem extends StatefulWidget {
  ...
  SingleItem({Key? key, required this.id, required this.storeProduct})
      : super(key: key);
...
class _SingleItemState extends State<SingleItem> {
  ...
  getPageData() async {
    ...
    if(mounted)await getRecipesData();
  }
  ...
  Future<bool> loadMoreData() async {
    ...
    var payload = {
      "product_id": widget.storeProduct!.products!.id,
      "page": page.toString(),
    };
    var response = await MjApiService()
        .postRequest(MJ_Apis.get_product_recipes + "/${user.id}", payload);
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Hero(
                                          ...
                                          child: CacheImage(
                                            url:
                                            "${MJ_Apis.APP_BASE_URL}${widget
                                                .storeProduct!.products!.image}",
                                            // width: 56,
                                            height: 140,
                                            fit: BoxFit.contain,
                                          ),
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: TouchableOpacity(
                                                      onTap: () {
                                                        context.read<CartHelper>()
                                                            .addToCart(
                                                            storeProductId: widget
                                                                .storeProduct!.id,
                                                            quantity: 1,
                                                            store_id: widget
                                                                .storeProduct!
