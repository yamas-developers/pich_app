...
import 'Ui/app_components/intro.dart';
    ...
    return IntroStepTarget(
      ...
      cardContents: TextSpan(
        text: "Welcome to use this package.\n"
            "This is the first step and \n there are ${controller.stepCount} steps here.",
      ),
      child: child,
    );
  }
...
class Block extends StatelessWidget {
  const Block({Key? key, required this.label, this.textColor = Colors.black}) : super(key: key);
  final String label;
